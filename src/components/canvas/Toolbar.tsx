    ...
    return (
        <div className="relative space-y-2">
            ...
            >
                ...
                {/* Main button */}
                <div
                    className={`relative w-full flex items-center justify-center gap-2 px-5 py-3 font-semibold rounded-2xl transition-all duration-200 hover:-translate-y-0.5 ${
                        zoomMode
            ...
            >
                ...
                {/* Main button */}
                <div
                    className="relative w-full flex items-center justify-center gap-2 px-5 py-3 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-2xl transition-all duration-200 hover:-translate-y-0.5">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
