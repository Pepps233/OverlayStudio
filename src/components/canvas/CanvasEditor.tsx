...
export default function CanvasEditor() {
    ...
    const [viewportOffset, setViewportOffset] = useState({
        x: (CANVAS_SIZE - BANNER_WIDTH) / 2,
        y: (CANVAS_SIZE - BANNER_HEIGHT) / 2
    });
    // Initial zoom state
    ...
    const handleLayerResize = useCallback((layerId: string, newWidth: number, newHeight: number, position?: {
        x: number;
        y: number
    }) => {
        setLayers((prev) =>
            prev.map((layer) =>
                layer.id === layerId
                    ? {
                        ...layer, width: newWidth, height: newHeight, ...(position ? {
                            x: position.x,
                            y: position.y
                        } : {})
                    }
            ...
            <div className="container mx-auto max-w-7xl px-6 pt-8 pb-24">
                ...
                <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
                    ...
                    <div className="w-full space-y-6 lg:w-[400px] lg:shrink-0 flex flex-col">
                        ...
                        <section
                            className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-5 border border-gray-100 dark:border-gray-700 shadow-sm">
                            <h2 className="mb-4 text-sm font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                                Assets
                            </h2>
                            <p className="mb-4 text-xs text-gray-600 dark:text-gray-400">
                                Didn't find your favorite animal, city, or cosmetic item? Contribute your images to
                                the{" "}
                                <a
                        ...
                        <div className="relative export-dropdown w-full max-w-[400px]">
                            ...
                            >
                                ...
                                <div
                                    className="absolute inset-0 bg-gray-900/40 rounded-2xl translate-y-1.5 blur-[2px]"/>
                                {/* Main button */}
                                <div
                                    className="relative flex items-center justify-center gap-2 w-full px-5 py-3 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-2xl transition-all duration-200 hover:-translate-y-0.5">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         ...
                                         className={`w-4 h-4 transition-transform duration-200 ${exportDropdownOpen ? 'rotate-180' : ''}`}>
                                        <path strokeLinecap="round" strokeLinejoin="round"
                            ...
                            {/* Dropdown Menu */}
                            <div
                                className={`absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50 transition-all duration-200 origin-top ${exportDropdownOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
                                <button
                                ...
                                >
                                    <div
                                        className="w-8 h-8 rounded-lg bg-violet-100 dark:bg-violet-900/30 flex items-center justify-center">
                                        <span
                                            className="text-sm font-bold text-violet-600 dark:text-violet-400">PNG</span>
                                    </div>
                                    <div>
                                        <p className="font-medium text-gray-900 dark:text-white">PNG Format</p>
                                        <p className="text-xs text-gray-500 dark:text-gray-400">Lossless, transparent
                                            background</p>
                                    </div>
                                </button>
                                <button
                                ...
                                >
                                    <div
                                        ...
                                        <span
                                            className="text-sm font-bold text-amber-600 dark:text-amber-400">JPG</span>
                                    </div>
                                    <div>
                    ...
                    <div className="min-w-0 flex-1 space-y-6" ref={containerRef}>
                        ...
                        <div
                            className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm">
                                        ...
                                        return (
                                            <div key={index}
                                                ...
                                                <div className="flex items-center gap-2 text-xs">
                                                    <span
                                                        className="text-gray-700 dark:text-gray-300 font-medium">{layer1?.name || 'Unknown'}</span>
                                                    ...
                                                    <span
                                                        className="text-gray-700 dark:text-gray-300 font-medium">{layer2?.name || 'Unknown'}</span>
                                                </div>
                                                <button
                                                    onClick={() => {
